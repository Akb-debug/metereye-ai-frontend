// Rôle : Tableau de bord pour les abonnés classiques.
// Affiche les index de consommation et les factures.
  ...
  template: `
    ...
    <nav class="navbar">
      ...
      <div class="nav-center">
        ...
        <span class="badge-role">Classique</span>
      </div>
    ...
    <main class="dashboard-content">
      <h1 class="page-title">Compteur Classique</h1>
      <p class="text-muted">Les données s'afficheront ici prochainement.</p>

      <div class="cards-grid">
        <div class="card">
          <div class="card-value">—</div>
          <div class="card-label">Index actuel</div>
        </div>
        <div class="card">
          <div class="card-value">—</div>
          <div class="card-label">Consommation ce mois</div>
        </div>
        <div class="card">
          <div class="card-value">—</div>
          <div class="card-label">Facture estimée</div>
        </div>
      </div>
    </main>
  `,
