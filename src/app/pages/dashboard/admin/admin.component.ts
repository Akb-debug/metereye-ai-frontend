// Rôle : Tableau de bord pour l'administration générale.
// Supervision du système complet.
...
@Component({
  ...
  template: `
    ...
    <main class="dashboard-content">
      <h1 class="page-title">Administration MeterEye AI</h1>
      ...
      <div class="cards-grid">
        ...
        <div class="card">
          <div class="card-value">—</div>
          <div class="card-label">Compteurs actifs</div>
        </div>
        <div class="card">
          <div class="card-value">—</div>
          <div class="card-label">Modules ESP32</div>
        </div>
        <div class="card">
          <div class="card-value">—</div>
